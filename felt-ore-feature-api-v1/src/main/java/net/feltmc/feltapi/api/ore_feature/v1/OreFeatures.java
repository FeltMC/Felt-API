...
public class OreFeatures {
    ...
    public static void createFilteredOrePlacedFeature(String domain, String id, BiFunction<BlockState, Random, BlockState> test, int minY, int maxY, int weight, int size, float discardChance, List<ResourceKey<Level>> dimensions, Predicate<BiomeSelectionContext> filtered){
    ...
    public static void createOrePlacedFeature(String domain, String id, BiFunction<BlockState, Random, BlockState> test, int minY, int maxY, int weight, int size, float discardChance, ResourceKey<Level>... dimensions){
    ...
    public static void createTrapezoidFilteredOrePlacedFeature(String domain, String id, BiFunction<BlockState, Random, BlockState> test, int minY, int maxY, int weight, int size, float discardChance, List<ResourceKey<Level>> dimensions, Predicate<BiomeSelectionContext> filtered){
    ...
    public static void createTrapezoidOrePlacedFeature(String domain, String id, BiFunction<BlockState, Random, BlockState> test, int minY, int maxY, int weight, int size, float discardChance, ResourceKey<Level>... dimensions){
    ...
    public static void createFilteredOrePlacedFeature(String domain, String id, BiFunction<BlockState, Random, BlockState> test, PlacementModifier range, PlacementModifier weight, int size, float discardChance, List<ResourceKey<Level>> dimensions, Predicate<BiomeSelectionContext> filtered){
    ...
    public static void createOrePlacedFeature(String domain, String id, BiFunction<BlockState, Random, BlockState> test, PlacementModifier range, PlacementModifier weight, int size, float discardChance, ResourceKey<Level>... dimensions){
