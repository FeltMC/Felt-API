...
public class OreFeatures {
    ...
    public static void createOrePlacedFeature(String domain, String id, RuleTest test, BlockState ore, int minY, int maxY, int weight, int size, float discardChance, RegistryKey<World>... dimensions){
        OreFeaturesData.createOrePlacedFeature(domain, id, new FeltRuleTest(domain, id, test, ore), HeightRangePlacementModifier.uniform(YOffset.fixed(minY), YOffset.fixed(maxY)), CountPlacementModifier.of(weight), size, discardChance, List.of(dimensions), List.of(), List.of());
    }
    ...
    public static void createOrePlacedFeature(String domain, String id, BiFunction<BlockState, Random, BlockState> test, int minY, int maxY, int weight, int size, float discardChance, RegistryKey<World>... dimensions){
        OreFeaturesData.createOrePlacedFeature(domain, id, new FeltRuleTest(domain, id, test), HeightRangePlacementModifier.uniform(YOffset.fixed(minY), YOffset.fixed(maxY)), CountPlacementModifier.of(weight), size, discardChance, List.of(dimensions), List.of(), List.of());
    }
    ...
    public static void createTrapezoidOrePlacedFeature(String domain, String id, BiFunction<BlockState, Random, BlockState> test, int minY, int maxY, int weight, int size, float discardChance, RegistryKey<World>... dimensions){
        OreFeaturesData.createOrePlacedFeature(domain, id, new FeltRuleTest(domain, id, test), HeightRangePlacementModifier.trapezoid(YOffset.fixed(minY), YOffset.fixed(maxY)), CountPlacementModifier.of(weight), size, discardChance, List.of(dimensions), List.of(), List.of());
    }
    ...
    public static void createTrapezoidOrePlacedFeature(String domain, String id, RuleTest test, BlockState ore, int minY, int maxY, int weight, int size, float discardChance, RegistryKey<World>... dimensions){
        OreFeaturesData.createOrePlacedFeature(domain, id, new FeltRuleTest(domain, id, test, ore), HeightRangePlacementModifier.trapezoid(YOffset.fixed(minY), YOffset.fixed(maxY)), CountPlacementModifier.of(weight), size, discardChance, List.of(dimensions), List.of(), List.of());
    }
    ...
    public static void createOrePlacedFeature(String domain, String id, BiFunction<BlockState, Random, BlockState> test, PlacementModifier range, PlacementModifier weight, int size, float discardChance, RegistryKey<World>... dimensions){
        OreFeaturesData.createOrePlacedFeature(domain, id, new FeltRuleTest(domain, id, test), range, weight, size, discardChance, List.of(dimensions), List.of(), List.of());
    }
}
